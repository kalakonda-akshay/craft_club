(function () {
    ...
    memberCardSlot.innerHTML = `
      <div class="id-card">
        ...
        <div class="id-card-bottom">
          ...
          <span class="qr-placeholder" title="View QR Code" onclick="openMemberQr('${entry.memberId}')" style="cursor:pointer; color:var(--accent);">▦</span>
        </div>
      </div>`;
  ...
  window.openMemberQr = function(memberId) {
    if (!memberId || memberId === "—") {
      alert("QR code not available for this member yet.");
      return;
    }
